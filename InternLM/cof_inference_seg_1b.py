...
if __name__ == '__main__':
    ...
    prompt_path = '../prompting/coco_seg/cof_prompts/'  # path to prompts, the prompts are generated from saliency score map.
    ...
    save_path = '../Results/COF/Seg_1B' # Save visualization results
    ...
    for i, (img, img_name) in enumerate(data_loader):
        ...
        # Prompts with diversity selection
        if diversity:
            diversity_scores = []
