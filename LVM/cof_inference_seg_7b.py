...
from utils import encode_transform, codebook_similarity
...
if __name__ == '__main__':
    ...
    validation_sample_path = '../dataset/coco/train2017/' # path of origin validation images
    test_sample_path = '../dataset/coco/val2017/' # path of origin test images
    save_path = '../dataset/coco/val2017/' # Save results
    ...
    for i, (img, img_name) in enumerate(data_loader):
        ...
        # closest_prompts = np.argsort(np.linalg.norm(codebooks-input_ids_np, axis=1, ord=0))[:20].tolist()
